    ...
    <div className='flex items-center justify-between text-sm py-4 mb-5 border-b border-b-gray-400'>
      ...
      <div className='flex items-center gap-4'>
        {token ? (
          ...
          <button onClick={() => navigate('/login')} className='bg-rose-500 text-white px-8 py-3 rounded-full font-light hidden md:block'>Create account</button>
        )}
        ...
        {/* Mobile Menu */}
        <div className={`${showMenu ? 'fixed' : 'hidden'} w-full md:hidden right-0 top-0 bottom-0 z-20 bg-white transition-all`}>
